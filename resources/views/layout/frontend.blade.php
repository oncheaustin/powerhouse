    ...
    <body class="bg-black">
        <header class="sticky top-0 z-20 bg-repeat bg-[#270F49]" style="background-image: url(assets/img/splash-bg.png); background-size: cover;  background-position: top; background-blend-mode: normal;  " >
            <div class="container max-w-screen-xl py-4 mx-auto w-[90%]   flex lg:grid lg:grid-cols-7 justify-between items-center">
                ...
                <div class=" nav-bar lg:col-span-3 block lg:flex fixed lg:relative w:[300px] lg:w-full right-[-300px] lg:right-0 top-0 p-10 lg:p-0 bg-[#03123B] lg:bg-transparent  text-white text-lg transition-all duration-700 ease-in-out" >
                    <svg onclick="openNav()" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 lg:hidden float-right">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                    </svg>
                    <ul class="clear-right lg:grid grid-cols-4 gap-5  space-y-5 lg:space-y-0" >
                        <li>
                            <a href="">HOME</a>    
                        </li>
                        <li>
                ...
                <div onclick="openNav()" class="lg:hidden cursor-pointer text-white" >
